...
2. Приложение передаёт в IIKO данные: "печатный чек не нужен" и Email клиента.

3. Фискальный регистратор отправляет клиенту электронный чек через оператор фискальных данных (ОФД).
